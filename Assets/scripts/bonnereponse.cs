...
public class bonnereponse : MonoBehaviour
{
...
//             Debug.Log("Bonne reponse");
//         }
//         else if (texteCouleur.text == "Vert" && collision.gameObject.tag == "vert") {
//             Debug.Log("Bonne reponse");
//         }
//         else if (texteCouleur.text == "Jaune" && collision.gameObject.tag == "jaune") {
//             Debug.Log("Bonne reponse");
//         }
